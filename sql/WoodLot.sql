...
INSERT INTO categoria (nome,descrizione)
	VALUES ("Salvaguardia Ambientale", "Gli alberi sono piantati in sistemi agroforestali che favoriscono l’interazione virtuosa tra le diverse specie e il loro impatto positivo sull’ambiente e sui terreni.");
INSERT INTO categoria (nome,descrizione)
	VALUES ("Sostegno economico", "I frutti degli alberi e i prodotti derivati dalla loro trasformazione, possono essere commerciati in circuiti locali, offrendo opportunità di reddito.");
INSERT INTO categoria (nome,descrizione)
...
INSERT INTO prodotto (nome, nomeScientifico, descrizione, sottotitolo, altezza, prezzo, pid, quantità, co2, salvaguardia,descrizioneBreve, doveVienePiantato) 
	VALUES ("Caboa", "Swietenia macrophylla King","La Caoba, pianta a foglia larga nativa della foresta tropicale, è un albero alto e maestoso che sovrasta la chioma della foresta. Può crescere fino a 50 metri di altezza ed ha un tronco con un diametro fino a 2-3 metri. Si tratta di una specie ad alto fusto a rischio estinzione per via della deforestazione e per l’elevato sfruttamento del suo legno pregiato.", "330 Kg di CO2 assorbit",30.00, 18.00, "Perù", 10 ,5, 5,"Caoboa era un termine indigeno che sta per 'frutto che non si mangia'. Particolamrmente appprezzato dagli ebanisti, durante gli anni  '90 il principlae esportatore fu la Bolivia ma, a causa di uno sfruttamento inadeguato, in questo caso la specie è quasi scomparsa","In Perù, all’interno dell’Amazzonia peruviana, piantiamo alberi in via d’estizione, partendo da sementi storiche raccolte nella foresta. Lo scopo è quello di proteggere e rigenerare la biodiversità, salvaguardare la cultura e le usanze indigene e assicurare uno sviluppo sostenibile tra società e foreste.");
INSERT INTO prodotto (nome, nomeScientifico, descrizione, sottotitolo, altezza, prezzo, pid, quantità, co2, salvaguardia,descrizioneBreve, doveVienePiantato) 
...
Quella che piantiamo in Guatemala non è l’arancia che tutti conosciamo: è molto aspra e viene utilizzata per lo più nella preparazione di piatti tipici.", "40 kg/anno di frutta prodotta", 3.50, 16.00, "Italia", 10, 5, 1,"I suoi fiori sono simbolo di matrimonio e amore fi da quando, secondo la mitologia greca, Gea-Dea della terra donò un albero di arancia per le nozze di Zeus e Hera. L'arancio è un antico ibrido nato più di 4000 anni fa dall'incrocio fra il pomeolo e il mandarino","Piantiamo l’arancia in Guatemala, nella regione del Petén. Le comunità contadine locali coltivano l’albero di arancia in terreni a rischio desertificazione. Dando vita a impianti agroforestali, e non monoculture, si assicura la rigenerazione graduale del suolo e della biodiversità animale e vegetale.
...
L’intero progetto della fattoria nasce appunto per ridurre il dissesto idrogeologico della zona.", "60 Kg/anno di frutta prodotta", 5.00, 35.00, "Italia", 10, 5, 5, "BOH BOH BHO perchè copio le cose da un sito fatto male ....","BOH BOH BHO perchè copio le cose da un sito fatto male ....");
INSERT INTO prodotto (nome, nomeScientifico, descrizione, sottotitolo, altezza, prezzo, pid, quantità, co2, salvaguardia,descrizioneBreve, doveVienePiantato) 
...
L’intero progetto della fattoria nasce appunto per ridurre il dissesto idrogeologico della zona.", "Salvaguardia Ambientale", 30.00, 35.00, "Italia", 10, 4, 3, "BOH BOH BHO perchè copio le cose da un sito fatto male ....","Nel vivaio della fattoria La Piemontesina, in cui crescono alberi forestali e da frutto. Gli alberi costituiscono le fondamenta delle attività educative sviluppate dalla fattoria, nata tra il 1982 e il 1984 accanto all’ex tenuta sabauda “La Mandria” di Chivasso, in provincia di Torino.
