...
<body>
	...
	<section class="py-5 text-center  container"
		style="background-image: url('resources/img/chiSiamoPage/01.jpeg');">
		<div class="row py-lg-5 jumbotron">
			<div class="col-lg-6 col-md-8 mx-auto">
				<h1 class="fw-light">Chi Siamo</h1>
				<p class="lead text-muted">La riforestazione è una delle azioni
					più efficaci nel contrasto alla crisi climatica. Noi ci impegniamo
					a far nascere nuovi alberi nelle regioni del mondo vittime di
					grandi deforestazioni.</p>
			</div>
		</div>
	</section>
